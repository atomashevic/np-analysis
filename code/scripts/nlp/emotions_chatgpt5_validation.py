...
if __name__ == "__main__":
    ...
    for TEMP in [1.0]:
        for COMPLETIONS_MODEL in ["gpt-5.4", "gpt-5.4-mini", "gpt-5", "gpt-5-mini"]:
            ...
            out_file = '../../results/emotions_gpt/emotions_%s_temp%s_validation_1.jsonl'%(COMPLETIONS_MODEL, TEMP)
